...
Follow the local/testnet-v0.9.7 branch of ChainX.
...
The structure of Runtime storage is consistent with the [ChainX - local/testnet-v0.9.7](https://github.com/chainpool/ChainX/tree/local/testnet-v0.9.7) and [substrate](https://github.com/chainpool/substrate).
...
# compile
cd ChainX
git checkout local/testnet-v0.9.7
